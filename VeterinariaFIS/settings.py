"""
Django settings for VeterinariaFIS project.
...
SECRET_KEY = 'f5=npwg&#3@2uk!1s7**fdmzd_j)+okh#89aum9f^=_o01(#v+'
...
WSGI_APPLICATION = 'VeterinariaFIS.wsgi.application'
